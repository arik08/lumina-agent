...
- Recompose long HTML reports as one coherent document when adding depth. Integrate new evidence into the existing sections and visual hierarchy, rebalance prose-heavy passages, and keep the executive conclusion at the logical end. Never grow a report by appending a chain of new prose sections after its conclusion.
