        ...
        <section className="feature-detail mcp-detail">
          {!selected || !currentRevision ? <div className="feature-state">MCP를 선택해 주세요.</div> : (
            <>
              ...
              {skillWrapperApplied === false && <div className="mcp-wrapper-warning" role="alert"><strong>Skill 래퍼가 없습니다.</strong><span>이 MCP를 실행할 때 사용 지침이 Context에 주입되지 않습니다. extensions/mcp/{selected.slug}/skills 아래에 metadata.lumina-source: skill-mcp:{selected.slug} 래퍼를 추가해 주세요.</span></div>}
